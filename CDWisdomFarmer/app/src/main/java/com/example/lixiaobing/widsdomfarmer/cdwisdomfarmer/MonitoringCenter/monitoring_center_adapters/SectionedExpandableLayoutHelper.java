...
import com.example.lixiaobing.widsdomfarmer.cdwisdomfarmer.MonitoringCenter.DividerItemDecoration;
...
public class SectionedExpandableLayoutHelper implements SectionStateChangeListener {
    ...
    public void addItem(String section, ArrayList<Item> items) {
        for(int i=0;i<items.size();i++){
            mSectionDataMap.get(mSectionMap.get(section)).add(items.get(i));
        }
    }
